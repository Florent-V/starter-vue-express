        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="text-right md:text-left order-3 md:order-2">
            <button
                type="submit"
                @click="save"
                class="w-full bg-blue-600 dark:bg-yellow-400 text-white dark:text-gray-900 hover:bg-blue-700 dark:hover:bg-yellow-500 px-6 py-3 rounded-lg text-lg transition duration-300 font-semibold"
            >
